...
- Resolution: Northstar PR 13 made sealed unit/class coverage authoritative,
  scoped missing `unrun` records to the call, and rejected colliding or
  ambiguous coverage before execution or write.
- Evidence: Northstar merge `dbce3856be6ec6093d2e5c071568a6dbe953df49`;
  staged-collection and no-side-effect regressions passed.
