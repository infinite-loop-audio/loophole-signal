...
title: "Retire the roadmap backlog in signal"
...
Run the one-time Northstar roadmap-backlog retirement in `signal`. Disposition
...
- Integration checkout: `/Users/tom/Dev/projects/signal` on clean synchronized
  `main` at `c21fa4fdc728855c6dfb585258d4eed9d7a1b889` before this handoff-only commit.
