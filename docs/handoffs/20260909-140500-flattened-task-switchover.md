...
title: "Flatten Northstar tasks and compact historic generations in signal"
...
Run the one-time Northstar flattened-task switchover in `signal`. Compact
...
- Integration checkout: `/Users/tom/Dev/projects/signal` on clean, synchronized `main` at the commit
